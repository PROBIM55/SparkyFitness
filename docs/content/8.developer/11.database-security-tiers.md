...
| `budget_identity_links` | Trusted mapping between BudgetApp users, family/member identities, and SparkyFitness users | System-Only (RLS on, no policies; BudgetApp SSO sync only) | System-Only |
